package de.uni.bielefeld.sc.hterhors.psink.scio.semanticmr.tools;
...
public class SCIOAutomatedSectionifcation {
	...
	public static void main(String[] args) throws IOException {
		...
		SystemScope.Builder.getScopeHandler().addScopeSpecification(DataStructureLoader.loadSlotFillingDataStructureReader("Injury")).build();
