...
import de.uni.bielefeld.sc.hterhors.psink.scio.semanticmr.preprocessing.InstanceCollection2.FeatureDataPoint;
...
public class InstanceCollection2 {
	...
	static public class FeatureDataPoint {
		...
		public FeatureDataPoint(String docID, int sentenceIndex, String sentence, InstanceCollection2 data,
	 ...
	 * @return
	 */
	public InstanceCollection2 removeRareFeatures(int minAppearence) {

		for (FeatureDataPoint featureDataPoint : dataPoints) {
			System.out.println("FTS" + featureDataPoint.score);
		}
		...
		InstanceCollection2 newI = new InstanceCollection2();
