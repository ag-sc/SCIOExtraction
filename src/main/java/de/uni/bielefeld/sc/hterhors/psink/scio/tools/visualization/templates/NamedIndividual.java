...
public class NamedIndividual implements IGraphMLContent {
	...
	private static String readTemplate() {
		try {
			return Files.readAllLines(new File("graphml/templates/named_individual.tmplt").toPath(), Charset.defaultCharset())
	...
	private NamedIndividual(int id, float height, float width, float x, float y, String name) {
		this.id = id;
	...
	public static class Builder {
		...
		public NamedIndividual build() {
			return new NamedIndividual(id, height, width, x, y, name);
		}
