...
public class TrendMajorityPredictor {
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 0)
			new TrendMajorityPredictor(1000L, "PREDICT");
		else
			new TrendMajorityPredictor(1000L, args[0]);
//			new TreatmentSlotFillingFinalEvaluation(1000L, "GOLD");
	...
	public TrendMajorityPredictor(long randomSeed, String modusName) throws IOException {
		...
		instanceDirectory = SlotFillingCorpusBuilderBib.getDefaultInstanceDirectoryForEntity(SCIOEntityTypes.trend);
