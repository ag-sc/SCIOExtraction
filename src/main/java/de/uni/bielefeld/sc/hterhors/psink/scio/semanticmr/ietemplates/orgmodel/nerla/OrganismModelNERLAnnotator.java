package de.uni.bielefeld.sc.hterhors.psink.scio.semanticmr.ietemplates.orgmodel.nerla;
...
public class OrganismModelNERLAnnotator {
	...
	public static void main(String[] args) {
		...
		RegularExpressionNerlAnnotator annotator = new RegularExpressionNerlAnnotator(
				...
				new OrganismModelPattern());

		File instanceDirectory = new File("src/main/resources/slotfilling/organism_model/corpus/instances/");
		...
		for (Instance instance : instanceProvider.getInstances()) {
			...
			try {
				...
				io.writeNerlas(new File("src/main/resources/slotfilling/organism_model/corpus/nerla/"
