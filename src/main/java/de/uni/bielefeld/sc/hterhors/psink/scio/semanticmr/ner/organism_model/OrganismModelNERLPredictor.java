 ...
 *
 */
public class OrganismModelNERLPredictor extends AbstractNERLPredictor {
...
//	private final File dictionaryFile = new File("src/main/resources/examples/nerla/dicts/organismModel.dict");
	...
	public OrganismModelNERLPredictor(String modelName, List<String> trainingInstanceNames,
	...
	protected File getInstanceDirectory() {
		return NERCorpusBuilderBib.getDefaultInstanceDirectoryForEntity(SCIOEntityTypes.organismModel);
	}
...
//		AbstractSampler sampler = new EpochSwitchSampler(e -> new Random(e).nextBoolean());
	...
	protected File getModelBaseDir() {
		return new File("models/ner/organismModel/");
	}
...
//	Final Score: Score [getF1()=0.058, getPrecision()=0.034, getRecall()=0.184, tp=32, fp=901, fn=142, tn=0]
	...
	protected Set<EntityType> getAdditionalCandidates() {
		...
		for (EntityType entityType : SCIOEntityTypes.organismModel.getRelatedEntityTypes()) {
