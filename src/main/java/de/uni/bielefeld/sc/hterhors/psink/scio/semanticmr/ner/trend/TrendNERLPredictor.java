 ...
 *
 */
public class TrendNERLPredictor extends AbstractNERLPredictor {
...
//	private final File dictionaryFile = new File("src/main/resources/examples/nerla/dicts/organismModel.dict");
	...
	protected File getInstanceDirectory() {
		return NERCorpusBuilderBib.getDefaultInstanceDirectoryForEntity(SCIOEntityTypes.trend);
	}
...
//	}
	...
	protected Set<EntityType> getAdditionalCandidates() {
		...
		System.out.println(SCIOEntityTypes.trend.getRelatedEntityTypes());
		set.addAll(SCIOEntityTypes.trend.getRelatedEntityTypes());
		return set;
	}
