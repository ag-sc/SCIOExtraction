...
public class OrgModelSpecs {
	 ...
	 */
	private static final File entities = new File("src/main/resources/slotfilling/organism_model/specifications/csv/entities.csv");

	/**
	 * Specification file that contains information about slots.
	 **/
	private static final File slots = new File("src/main/resources/slotfilling/organism_model/specifications/csv/slots.csv");
	/**
