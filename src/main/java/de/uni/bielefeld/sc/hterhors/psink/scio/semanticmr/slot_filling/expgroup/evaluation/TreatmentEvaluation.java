...
//			goldAnnotations.forEach(g -> log.info(g.toPrettyString()));
//			log.info("----------------_");
//			predictedAnnotations.forEach(p -> log.info(p.toPrettyString()));
...
//		log.info("TREATMENTS MACRO: F1 = " + macroF1 + ", P = " + macroPrecision + ", R = " + macroRecall);
		log.info("TREATMENTS " + scoreType + ": BOTH = " + bothS);
		log.info("TREATMENTS " + scoreType + ": Vehicle = " + vehicleScore);
		log.info("TREATMENTS " + scoreType + ": Non Vehicle = " + nonVehicleScore);
		ps.println("TREATMENTS " + scoreType + ": BOTH = " + bothS);
		ps.println("TREATMENTS " + scoreType + ": Vehicle = " + vehicleScore);
		ps.println("TREATMENTS " + scoreType + ": Non Vehicle = " + nonVehicleScore);
		return bothS;
	}

	private Score simpleTreatmentEvaluate(List<EntityTemplate> goldAnnotations,
			List<EntityTemplate> predictedAnnotations, ESimpleEvaluationMode mode, EScoreType scoreType) {
