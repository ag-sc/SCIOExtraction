package de.uni.bielefeld.sc.hterhors.psink.scio.semanticmr.ietemplates.investigationmethod.nerla;
...
public class InvestigationMethodNERLAnnotator {
	...
	public static void main(String[] args) {
		...
		File instanceDirectory = new File("src/main/resources/slotfilling/investigationmethod/corpus/instances/");
		...
		for (Instance instance : instanceProvider.getInstances()) {
			...
			try {
				...
				io.writeNerlas(new File("src/main/resources/slotfilling/investigationmethod/corpus/nerla/"
