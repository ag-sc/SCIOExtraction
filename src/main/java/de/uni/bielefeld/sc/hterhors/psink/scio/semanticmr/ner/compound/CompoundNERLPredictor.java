 ...
 *
 */
public class CompoundNERLPredictor extends AbstractNERLPredictor {
...
//	private final File dictionaryFile = new File("src/main/resources/examples/nerla/dicts/organismModel.dict");
	...
	public CompoundNERLPredictor(String modelName, List<String> trainingInstanceNames,
	...
	protected File getInstanceDirectory() {
		return NERCorpusBuilderBib.getDefaultInstanceDirectoryForEntity(SCIOEntityTypes.compound);
	}
...
//		AbstractSampler sampler = new EpochSwitchSampler(e -> new Random(e).nextBoolean());
	...
	protected File getModelBaseDir() {
		return new File("models/ner/compound/");
	}

	@Override
	protected Set<EntityType> getAdditionalCandidates() {
		Set<EntityType> set = new HashSet<>();
		set.addAll(SCIOEntityTypes.compound.getTransitiveClosureSubEntityTypes());
		return set;
	}
