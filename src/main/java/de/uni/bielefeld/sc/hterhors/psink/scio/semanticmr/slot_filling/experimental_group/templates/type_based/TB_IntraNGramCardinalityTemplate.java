...
import de.uni.bielefeld.sc.hterhors.psink.scio.semanticmr.slot_filling.experimental_group.templates.type_based.TB_IntraNGramCardinalityTemplate.IntraTokenScope;
 ...
 * @date Nov 15, 2017
 */
public class TB_IntraNGramCardinalityTemplate extends AbstractFeatureTemplate<IntraTokenScope> {
	...
	private static final int MIN_GRAM_LENGTH = 2;
...
//						continue;
				...
				if (featureName.length() < MIN_GRAM_LENGTH)
					continue;
